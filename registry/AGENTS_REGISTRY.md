...
| [docs-claim-claim-judge](../src/agents/docs/docs-claim-claim-judge/docs-claim-claim-judge.md) | Read-only entailment-verification agent for the docs-claim-doc-shrinker workflow. Judges whether a single claim is semantically preserved in a rewritten doc; returns entailed \| partial \| dropped with evidence span. Designed for batch dispatch (one call per claim). | draft | docs-claim-doc-shrinker |
