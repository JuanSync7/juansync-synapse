...
| [docs-claim-doc-writer](../src/agents/docs/docs-claim-doc-writer/docs-claim-doc-writer.md) | Rewrites a claim-based doc against a fixed kept-claim set; preserves every source heading; for style sub-type, matches cadence via 3–5 voice anchors. No self-verify (judge sibling owns entailment). Reuse-review checkpoint 2026-08-13. | draft | docs-claim-doc-shrinker |
