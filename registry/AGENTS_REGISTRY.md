...
| [docs-claim-doc-extractor](../src/agents/docs/docs-claim-doc-extractor/docs-claim-doc-extractor.md) | Extracts atomic claims from a claim-based markdown doc. Returns a list of claim objects anchored by source heading, plus auto-flagged contradictions and redundancies. Read-only. | draft | docs-claim-doc-shrinker |
