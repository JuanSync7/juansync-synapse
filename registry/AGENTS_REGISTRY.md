...
| [docs-claim-doc-classifier](../src/agents/docs/docs-claim-doc-classifier/docs-claim-doc-classifier.md) | Read-only entry-gate classifier for the docs-claim-doc-shrinker workflow. Returns structural genre (claim-based, narrative, reference, tutorial, template, mixed), claim sub-type, and confidence. | draft | docs-claim-doc-shrinker |
