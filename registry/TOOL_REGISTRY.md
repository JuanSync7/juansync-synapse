...
| [lint-reporter](../src/tools/testing/lint_reporter/) | Aggregates ruff, mypy, bandit, and vulture into a single structured LintReport | draft | test-lint |
| [branch-mapper](../src/tools/testing/branch_mapper/) | Enumerates executable branches per public function — including transitive private helpers — for test generation | draft | test-generate |
| [assertion-quality](../src/tools/testing/assertion_quality/) | Scores pytest test functions by assertion strength — flags trivial, tautological, and missing assertions | draft | test-generate |
...
| [mutation-runner](../src/tools/testing/mutation_runner/) | Generates AST mutants of a target function and runs the test suite per mutant to detect weak assertions | draft | test-generate |
| [hypothesis-strategy-generator](../src/tools/testing/hypothesis_strategy_generator/) | Emits Hypothesis @given strategies from function type hints — for property-based test generation | draft | test-generate |
| [boundary-classifier](../src/tools/testing/boundary_classifier/) | Classifies every function as boundary (runtime-exposed) or internal — directs where to apply boundary-style tests | draft | test-evaluate |
