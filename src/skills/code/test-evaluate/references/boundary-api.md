...
Per-category reference for `test-evaluate`. Loaded at [DETECT] when the module category is HTTP/external API. Functions are classified as **boundary-runtime**, **boundary-logical**, or **internal**.
