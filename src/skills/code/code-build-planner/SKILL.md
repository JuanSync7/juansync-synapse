...
**Announce at start:** "I'm using the code-build-planner skill to create a bias-free implementation plan."
...
**Input requirements:**
1. An implementation docs document (from `docs-implementation-writer`) — the source of truth for contracts, task sections, and dependency graph
...
- **User has a design document from `docs-design-writer`** → this skill is correct; proceed
