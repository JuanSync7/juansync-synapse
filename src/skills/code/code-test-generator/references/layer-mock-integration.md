...
Loaded at the [GENERATE] node of the code-test-generator skill.
...
The code-test-evaluator skill (downstream) classifies which tests are "high-value" and
...
Any mock-integration test that code-test-evaluator classifies as "high-value" is a
