...
Evaluation criteria for the `test-generate` skill at `/home/juansync7/juansync-synapse/src/skills/code/test-generate/SKILL.md`.
...
### EVAL-T03
**Persona:** Naive User
**Prompt:** "run test-generate with --no-pr"
...
### EVAL-E10
Missing/unparseable `AuditGapReport` → wrong-tool redirect to `/test-audit` before any [BRANCH-MAP] node Position header is emitted.
