...
The answers usually surface an archetype in disguise. If not, the target may not be a good fit for optimization-process-researcher — some things genuinely lack a scorable metric, and the right move is to recognize that and stop rather than invent a fake scorer.
