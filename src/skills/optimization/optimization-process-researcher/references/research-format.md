...
Created by optimization-process-researcher runs. Contains two files. The agent creates this directory on its first iteration — do not pre-create it.
...
```markdown
# optimization-process-researcher — Research Changelog
