...
This file is the **self-contained prompt** an optimization-process-researcher iteration subagent receives. You are reading this because you have been dispatched by the optimization-process-researcher orchestrator to run exactly one iteration of an autonomous improvement loop. You do **not** load the optimization-process-researcher SKILL.md — everything you need is in this file plus the slots the orchestrator fills in.
...
- **Do not load the optimization-process-researcher SKILL.md.** Everything you need is in this file and the passed slots.
