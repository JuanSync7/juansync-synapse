...
### Why the reframe
<what surfaced during the meta-process-brainstormer that showed the original framing was wrong>

### What's next
<does the user need a new meta-process-brainstormer on the revised framing, or is the reframe itself the deliverable?>
...
<which sub-topic to meta-process-brainstormer first, and why — what unblocks the others>
...
<!-- PROSE suggestion, NOT a deterministic shape→skill map. Examples:
     - "If you want to turn this Spec into requirements, `/docs-spec-writer` is a good next step."
     - "This Plan is a good candidate for `/code-build-planner` to decompose into tasks."
     - "For the Decision, just go execute. No handoff needed."
     - "If this Reframe is the deliverable, no handoff; if you want to meta-process-brainstormer the revised question, invoke `/meta-process-brainstormer` again."
-->
