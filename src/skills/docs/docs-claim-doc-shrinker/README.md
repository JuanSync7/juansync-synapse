...
|-------|------|-------------|
| [docs-claim-doc-shrinker](SKILL.md) | shrinker | Two-phase: `audit` writes a per-claim keep/cut/merge checklist; `compress` rewrites the doc preserving every kept claim with post-write entailment verification. |
