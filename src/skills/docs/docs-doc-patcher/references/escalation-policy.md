...
Defines when docs-doc-patcher should refuse to patch a document and instead delegate to the appropriate write-* skill. Loaded during Phase 3 (Patch) when the scope of a required update exceeds what a targeted patch can handle.
...
|----------|------------|
| Engineering guide | `/docs-engineering-guide-writer` |
| Spec | `/docs-spec-writer` |
| Spec-summary | `/docs-spec-summarizer` |
| Test-docs | `/docs-test-plan-writer` |
| Test-coverage.md | `/docs-coverage-writer` |
