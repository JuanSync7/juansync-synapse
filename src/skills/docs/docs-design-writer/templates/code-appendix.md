...
Contract entries are **exact and complete** — copied verbatim into `docs-implementation-writer` Phase 0.
...
- Test code (belongs in docs-test-plan-writer)
- Execution steps, pytest commands, commit instructions (belongs in docs-implementation-writer)
