...
| Contract entry labelled as pattern | docs-implementation-writer Phase 0 is missing types/stubs — agents can't build against incomplete interfaces | Contracts define interfaces (types, stubs, exceptions); patterns show algorithms |
