...
docs-spec-writer now produces a companion `_SPEC_MAP.md` alongside every spec. This file contains a knowledge graph index: section list, entity index (entity → defined in → referenced by), and REQ index (range → section → tally).
