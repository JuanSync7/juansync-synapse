# Decision Memo — docs-claim-shrinker
...
| `registry/SKILL_REGISTRY.md` | produces for | New row: `docs-claim-shrinker` |
...
- File layout: `src/skills/docs/docs-claim-shrinker/SKILL.md` + `references/` + `templates/`
