...
Show directional module-to-module call patterns. These specify the call graph and error propagation expectations that `docs-engineering-guide-writer` and `docs-test-plan-writer` will rely on.
